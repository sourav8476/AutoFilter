...
OWNER_ID = environ.get('OWNER_ID', '6402721511')
...
STREAM_API = (environ.get('STREAM_API', '29b557074aa857e56ca7fd6ad2e42ef2788e8443'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/how_to_download_moviezone/5'))
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002216660895")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
BOT_USERNAME = environ.get("BOT_USERNAME", "shinobufilterbot")
BOT_NAME = environ.get("BOT_NAME", "𝐒𝐡𝐢𝐧𝐨𝐛𝐮 𝐊𝐨𝐜𝐡𝐨")
BOT_ID = environ.get("BOT_ID", "6751015037")
